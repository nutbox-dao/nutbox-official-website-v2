export default {
  ...
  nutboxSection: {
    ...
    p2: 'DeFi, 治理, NFT 以及更多',
    t3: '支持多链',
    p3: '目前支持 Cosmos, Steem, Hive, 后续会支持主流Pos链比如Solana, Polkadot, Ethereum2.0 等.'
  },
  stakingSection: {
    btn1: '开始质押',
    t1: '$NUT原生代币',
    p1: '$NUT是Nutbox经济的原生代币，为成员和社区提供利益和服务，并支配着Nutbox的治理。',
    p2: 'Nutbox Voting Power(简称NUT Power)是Nutbox DAO的治理权力。用户的Nutbox治理奖励是由用户的治理活动收取的.',
    btn2: '了解更多'
  },
  peanutSection: {
    btn1: '探索 Peanut',
  ...
  roadmapSection: {
    title: '路线图',
    t1: '十月 2020',
    p1: '在Tron网络上创建并上线Peanut DAO',
    t2: '十一月 2021',
    p2: '在BSC网络上上线Nutbox ver0.1',
    t3: 'Q1 2022',
    p3: '在BSC主网上上线Nutbox Walnut, 支持Steem/Hive 以及 Polkadot',
    t4: 'Q2 2022',
    p4: '在Walnut上上线工具箱投票, ISO 支持 Cosmos, Osmosis 以及 Astar networks',
    t5: 'Q3 2022',
    p5: 'Walnut ISO 支持更多网络, 比如Ethereum, Solana, 等.',
    t6: 'Q4 2022',
    p6: '上线 Chestnut',
    t7: 'Q1-Q2 2023',
    p7: '工具箱 and 社交模块 (Donut)',
    t8: 'Q3-Q4 2023',
    p8: 'Nutbox在Polkadot生态的链'
  },
  partnerSection: {
    title: '合作伙伴'
  },
  communitySection: {
    title: '加入<span class="gradient-text gradient-text-bottom">Nutbox 生态</span> 的社区'
  },
  missionSection: {
    title: '我们的使命',
    p1: '创建从质押协议到下一个大型 DAO 的任何东西。自动将社区 Token 分发给贡献者',
    p2: 'Peanut <br>Nutbox 创建的<span class="gradient-text gradient-text-bottom">第一个</span> 质押DAO.',
    p3: 'Nutbox 构建的第一个质押DAO',
    p4: 'Steem区块链第二大质押平台',
    p5: 'STEEM POWER 的质押价值',
    p6: 'PNUT市值'
  },
  grantSection: {
    title: '赞助',
  ...
  faqSection: {
    title: '<span class="gradient-text gradient-text-bottom">常见问题</span>',
    q1: 'Nutbox是什么?',
    ...
    q4: ' NUT是如何分配的?',
    a4: 'NUT总数为10亿。根据分配方式的不同，分为2类' +
      '<br>' +
      '① 65% 用于支持 Nutbox 生态建设，包括整理者、插槽拍卖、协议开发、工具包、质押;' +
      '<br>' +
      '② 35%用于MKT、私募和分配创始团队。',
